	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { className: 'search-box', type: 'text', placeholder: 'search....',
	      ...
	      React.createElement(
	        ...
	        this.state.shows.filter(function (show) {
	          return (show.title + ' ' + show.description).toUpperCase().indexOf(_this.state.searchQuery.toUpperCase()) >= 0;
	        }).map(function (show) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginBox = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    request.onload = function () {
	      if (request.status === 200) {
	        var receinvedUser = JSON.parse(request.responseText);
	        _this.setUser(receinvedUser);
